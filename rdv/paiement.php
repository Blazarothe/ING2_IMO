...
// Récupérer l'ID de la propriété depuis les paramètres de l'URL
$proprieteId = isset($_GET['propriete_id']) ? $_GET['propriete_id'] : '';

// Vérifier que l'ID de la propriété est présent
if (!$proprieteId) {
...
$sql = "SELECT * FROM Proprietes WHERE propriete_id = ?";
