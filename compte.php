...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_info'])) {
    ...
    $updateSql = "UPDATE users SET lname=?, fname=?, email=?, password=? WHERE user_id=?";
...
$rdvSql = ($typeUtilisateur == 'client') ? 
    "SELECT rv.date_heure, p.adresse, ua.lname AS agent_nom, ua.fname AS agent_prenom, uc.lname AS client_nom, uc.fname AS client_prenom 
     FROM RendezVous rv 
     JOIN Proprietes p ON rv.propriete_id = p.propriete_id 
     JOIN Agents a ON rv.agent_id = a.id
     JOIN users ua ON a.utilisateur_id = ua.user_id
     JOIN users uc ON rv.client_id = uc.user_id
