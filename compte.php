...
$rdvSql = ($typeUtilisateur == 'client') ? 
    "SELECT rv.date_heure, p.adresse, u.nom AS agent_nom, u.prenom AS agent_prenom FROM RendezVous rv JOIN Proprietes p ON rv.propriete_id = p.propriete_id JOIN Utilisateurs u ON rv.agent_id = u.id WHERE rv.client_id = ? AND rv.statut = 'confirmé'" :
    "SELECT rv.date_heure, p.adresse, u.nom AS client_nom, u.prenom AS client_prenom FROM RendezVous rv JOIN Proprietes p ON rv.propriete_id = p.propriete_id JOIN Utilisateurs u ON rv.client_id = u.id WHERE rv.agent_id = ? AND rv.statut = 'confirmé'";
